      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <h2 style={{ margin: 0, fontSize: '2.2rem', color: 'var(--text-color)' }}>{word}</h2>
            <button
              onClick={() => speakWord(word)}
              style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px', display: 'inline-flex' }}
              title="Произнести слово"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="var(--text-color)" viewBox="0 0 256 256">
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--text-color)" viewBox="0 0 256 256">
