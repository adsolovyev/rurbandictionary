...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScrollY > lastScrollY.current && isMenuOpen) closeMenu();
  ...
  return (
    <>
      <header style={{ borderBottom: '1px solid #2a2f3a', backgroundColor: '#212936' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '0.25rem', paddingBottom: '0.25rem', gap: '4px' }}>
          <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', flexShrink: 0 }}>
            <svg viewBox="0 0 240 129" preserveAspectRatio="xMidYMid meet" className="logo" style={{ height: '32px', width: 'auto', marginRight: '4px' }} aria-label="Логотип Russian Urban Dictionary">
