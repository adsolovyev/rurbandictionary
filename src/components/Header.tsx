    ...
    <>
      <header style={{ borderBottom: '1px solid #2a2f3a', backgroundColor: '#212936' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
          <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', flexShrink: 0 }} title="Russian Urban Dictionary Educational">
            <svg className="logo" viewBox="0 0 240 129" preserveAspectRatio="xMidYMid meet" style={{ height: '40px', width: 'auto', marginRight: '8px' }} aria-label="Логотип Russian Urban Dictionary">
